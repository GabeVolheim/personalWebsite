...
const AboutMe = () => {
    ...
    <div className="flex justify-between items-center text-white font-bebas mt-32">
        ...
        <img src={mugshot} alt="Headshot!" className="w-3/5 sm:w-1/5 lg:w-3/5 lg:w-1/5 h-auto mr-64 rounded-lg border-4 border-white shadow-9xl transform transition duration-500 hover:scale-105 hover:shadow-lg"></img>
    </div>
    );
}
